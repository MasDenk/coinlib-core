import { BaseMultisigData, createUnitConverters, MultisigData, NetworkType } from '../lib-common'
...
import { bitcoinish, NETWORKS as BITCOIN_NETWORKS, BitcoinjsNetwork } from '../lib-bitcoin'
