...
import { BaseDashPaymentsConfig, PsbtInputData } from './types'
import { BITCOIN_SEQUENCE_RBF, DEFAULT_FEE_LEVEL_BLOCK_TARGETS } from './constants'
import { isValidAddress, isValidPrivateKey, isValidPublicKey, standardizeAddress, estimateDashTxSize } from './helpers'

// tslint:disable-next-line:max-line-length
export abstract class BaseDashPayments<
  Config extends BaseDashPaymentsConfig,
