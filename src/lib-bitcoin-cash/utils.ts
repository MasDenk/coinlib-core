...
import { BitcoinCashBaseConfig } from './types'
...
export function toBitcoinishConfig<T extends BitcoinCashBaseConfig>(config: T): bitcoinish.BitcoinishPaymentsConfig {
