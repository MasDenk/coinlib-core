...
export const KeyPairsConfigParam = t.union(
  [t.array(NullableOptionalString), t.record(t.number, NullableOptionalString)],
  'KeyPairsConfigParam',
)
...
export const AutoFeeLevels = t.union(
  [t.literal(FeeLevel.Low), t.literal(FeeLevel.Medium), t.literal(FeeLevel.High)],
  'AutoFeeLevels',
)
...
export type FilterBlockAddressesCallback = (
  addresses: string[],
  blockInfo: FilterBlockAddressesBlockInfo,
