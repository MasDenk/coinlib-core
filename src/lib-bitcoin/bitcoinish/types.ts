...
export const BlockbookConfigServer = t.union([t.string, t.array(t.string), t.null], 'BlockbookConfigServer')
...
export const BitcoinishSignedTransaction = extendCodec(
  BaseSignedTransaction,
  {
...
export const BitcoinishTransactionInfo = extendCodec(
  BaseTransactionInfo,
  {
