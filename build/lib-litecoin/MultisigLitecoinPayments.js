...
exports.MultisigLitecoinPayments = void 0;
...
class MultisigLitecoinPayments extends BaseLitecoinPayments_1.BaseLitecoinPayments {
    constructor(config) {
        super(config);
        this.config = config;
        ...
        this.signers = config.signers.map((signerConfig, i) => {
            ...
            const payments = types_1.HdLitecoinPaymentsConfig.is(signerConfig)
                ? new HdLitecoinPayments_1.HdLitecoinPayments(signerConfig)
                : new KeyPairLitecoinPayments_1.KeyPairLitecoinPayments(signerConfig);
...
exports.MultisigLitecoinPayments = MultisigLitecoinPayments;
exports.default = MultisigLitecoinPayments;
//# sourceMappingURL=MultisigLitecoinPayments.js.map