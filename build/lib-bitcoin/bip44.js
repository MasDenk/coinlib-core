...
exports.validateHdKey = exports.isValidXpub = exports.isValidXprv = exports.xprvToXpub = exports.derivePrivateKey = exports.deriveAddress = exports.deriveKeyPair = exports.deriveHDNode = exports.splitDerivationPath = exports.bip32MagicNumberToPrefix = void 0;
const bitcoinish_1 = require("./bitcoinish");
Object.defineProperty(exports, "bip32MagicNumberToPrefix", { enumerable: true, get: function () { return bitcoinish_1.bip32MagicNumberToPrefix; } });
...
function deriveHDNode(hdKey, derivationPath, network) {
    const rootNode = hdKey.startsWith('xprv') || hdKey.startsWith('xpub') ? lib_common_1.bip32.fromBase58(hdKey) : lib_common_1.bip32.fromBase58(hdKey, network);
...
function deriveAddress(baseNode, index, network, addressType) {
    ...
    return (0, helpers_1.publicKeyToAddress)(keyPair.publicKey, network, addressType);
}
