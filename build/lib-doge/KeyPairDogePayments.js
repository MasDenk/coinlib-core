...
exports.KeyPairDogePayments = void 0;
...
class KeyPairDogePayments extends SinglesigDogePayments_1.SinglesigDogePayments {
    constructor(config) {
        super(config);
        this.config = config;
        this.publicKeys = {};
...
exports.KeyPairDogePayments = KeyPairDogePayments;
exports.default = KeyPairDogePayments;
//# sourceMappingURL=KeyPairDogePayments.js.map