...
class HdDashPayments extends SinglesigDashPayments_1.SinglesigDashPayments {
    constructor(config) {
        super(config);
        this.config = config;
        (0, ts_common_1.assertType)(types_1.HdDashPaymentsConfig, config);
...
exports.HdDashPayments = HdDashPayments;
//# sourceMappingURL=HdDashPayments.js.map