...
exports.BaseDashPayments = void 0;
...
class BaseDashPayments extends lib_bitcoin_1.bitcoinish.BitcoinishPayments {
    constructor(config) {
        var _a;
    ...
    estimateTxSize(inputCount, changeOutputCount, externalOutputAddresses) {
        return (0, helpers_1.estimateDashTxSize)({ [this.getEstimateTxSizeInputKey()]: inputCount }, {
...
exports.BaseDashPayments = BaseDashPayments;
//# sourceMappingURL=BaseDashPayments.js.map